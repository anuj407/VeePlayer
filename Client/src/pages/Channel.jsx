...
import { fetchUserVideos, selectUserVideos } from "../store/Reducers/UserVideoSlice"
import { fetchVideos } from "../store/Reducers/VideoSlice"

function Channel() {

  const {_id,fullName,username,avatar,coverImage,subscribersCount,} = useSelector(getChannel)
                      ...
                      <div className="w-[90%] py-6 flex flex-col items-center gap-6 ">  
                          ...
                          <div className="w-full">
                              ...
                              <div className="flex mt-2">
                                {videos.map((video,index)=><div key={index} className={`${index < 3 ? `block`:`hidden`}`}><VideoCard video={video}/></div>
                                )}
                              </div>
                          </div>
                          <div className="w-full h-[0.8px] bg-[#616161]"></div>
