...
function Home() {
  ...
  return (
    <div className="min-h-screen">
        <Navbar/>
        <div onClick={handleHomeButton} className="w-[7%] fixed left-0 top-[5rem] h-12 flex items-center justify-center ">
           <assets.IoMenuOutline className="w-[80%] h-[80%] py-1 hover:bg-[#3f3f3f] cursor-pointer  rounded-xl" />
        </div>
        <div className={`${fullSideBar ? `w-[16%] px-4`:`w-[6%]`} bg-black flex flex-col gap-8 text-[0.8rem] fixed top-32 py-3`}>
        ...
        <div className={`py-3 pl-1 mt-32 ${fullSideBar ? `ml-[16%]` :`ml-[6%]`} flex flex-wrap gap-4`}>
        {
