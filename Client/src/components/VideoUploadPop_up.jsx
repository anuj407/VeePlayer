  ...
  return (
    <>
      <div className={`w-[65vw] h-[90vh] bg-[#282828] rounded-3xl flex flex-col ${isUploading ? `gap-7` : `gap-12`}`}>
          ...
          {isUploading ?
              <div className="flex h-[83%] flex-col items-center gap-y-6 overflow-y-scroll scrollbar-hide">
                <div className="w-[80%] h-[10%] flex justify-between relative">
